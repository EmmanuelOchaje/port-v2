      ...
      >
        ...
        >
          <Image
            ...
            className="max-w-20rem rounded-3xl"
            alt=""
          />
        </motion.div>
        <motion.div
        ...
        >
          <p className="mb-10 max-w-2xl">
            I am an experienced Frontend Developer with over 4years of
          ...
          <motion.ul
            ...
            whileInView={{ opacity: 1 }}
            transition={{ duration: 1 }}
            className="grid grids-cols-1 sm:grid-cols-3 gap-6 max-w-2xl"
          >
            {infoList.map(({ icon, iconDark, title, description }, index) => (
              <motion.li
                whileHover={{ scale: 1.05 }}
                className="border-[0.5px] border-gray-400 rounded-xl p-6 cursor-pointer hover:bg-lightHover hover:-translate-y-1 duration-500 dark:border-white dark:hover:bg-blue-950"
                key={index}
              >
                <Image
          ...
          <motion.ul
            ...
            whileInView={{ opacity: 1 }}
            transition={{ duration: 0.5, delay: 1.3 }}
            className="flex gap-4 items-center sm:gap-5"
          >
